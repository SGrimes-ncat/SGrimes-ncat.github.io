...
$delete = @$_POST["delete"];
if ($delete == "Delete"){
  $dtruck_name = @$_POST["dtruck_name"];
  $checkbox = @$_POST["checkbox"];
  // delete record
    	
    foreach ($checkbox as $index){
    $sql = "delete from $tblname where truck_name='$dtruck_name[$index]'";
   ...
   <form name="myform" method="post" action="delete.php" onSubmit="return checkboxchecked()">
     ...
     <?php
      ...
      while($row = mysqli_fetch_assoc($result)) {
        ...
        echo "</td><td valign=\"bottom\"><h4><a href=\"detail.php?truck_name=$truck_name\">$truck_name</a><h4></td></tr>";
        echo "<input type=\"hidden\" name=\"dtruck_name[]\" value=\"$truck_name\" />";
        $index++;
      }
